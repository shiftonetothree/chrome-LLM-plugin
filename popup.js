...
import { TabDataStore } from './tab-data-store.js';
...
function buildSystemContent() {
  ...
  if (pageContext) {
    ...
    /* 
      Convert page video subtitles to text format.
    */
    ...
    /* 
      Convert page comments to text format.
    */
